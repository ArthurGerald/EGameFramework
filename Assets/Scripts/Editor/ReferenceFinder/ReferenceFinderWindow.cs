...
public class ReferenceFinderWindow : EditorWindow
{
    ...
    //查找资源引用信息
    [MenuItem("Lop/程序/Find References In Project", false)]
    static void FindRef()
    {
        InitDataIfNeeded();
        OpenWindow();
    ...
    //打开窗口
    [MenuItem("Lop/程序/Reference Finder", false)]
    ...
    public void DrawOptionBar()
    {
        ...
        isDepend = GUILayout.Toggle(isDepend, isDepend ? "Model(查看依赖)" : "Model(查看引用)", toolbarButtonGUIStyle, GUILayout.Width(100));
